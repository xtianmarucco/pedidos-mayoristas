...
import  { faShoppingCart, faUser, faSignOutAlt, faClipboardList }from '@fortawesome/free-solid-svg-icons';
    ...
    <nav className="bg-blue-800">
      <div className="container mx-auto flex justify-between items-center h-16">
        <div className="text-white text-2xl font-bold h-full flex items-center">
          <Link to="/customer" className="h-full flex items-center active:bg-blue-500">
            Pedidos Mayoristas
          </Link>
        </div>
        <ul className="flex space-x-4 items-center h-full">
          {isAuthenticated && (
            <>
              <li className="h-full">
                <Link to="/order-history" className="text-white font-medium h-full flex items-center px-4 hover:bg-blue-700 active:bg-blue-500">
          ...
          <li className="h-full">
                <button onClick={handleLogout} className="text-white font-medium h-full flex items-center px-4 hover:bg-blue-700 active:bg-blue-500">
