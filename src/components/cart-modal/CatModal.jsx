...
const CartModal = ({ onClose }) => {
  ...
  return (
    <div className="absolute w-full bg-black bg-opacity-50 flex justify-center items-center">
        ...
        {cartItems.length > 0 ? (
          <div>
            ...
            <div className="flex justify-between items-center mt-6">
              ...
              <button onClick={handleClearCart} className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 transition-colors duration-200">
                Clear Cart
              </button>
            </div>
            <button
